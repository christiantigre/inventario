...
class BackupController extends Controller
{
     ...
     */
    public function delete(Request $request, $file, $file_name)
    {
    	$rutaDeArchivo = storage_path() .'\\'. $file.'\\'. $file_name;
    	if (Storage::url('\\'. $file.'\\'.$file_name)) {
    		$url = Storage::delete('\\'. $file.'\\'.$file_name);
    	}else{
    		abort(404, trans('backpack::backup.backup_doesnt_exist'));
    	}
