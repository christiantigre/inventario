...
<section class="content">
            ...
            <div class="col-md-10 col-lg-10 col-xs-12 col-sm-8">
                <div class="panel panel-default">
                    <div class="panel-heading">Crear Nueva Cuenta</div>
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{{ url('/admin/cuenta') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            @include ('admin.cuenta.form')
