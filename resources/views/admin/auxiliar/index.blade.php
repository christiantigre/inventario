                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-xs-12 col-sm-6">
                            ...
                            <a href="{{ url('/admin/auxiliar/create') }}" class="btn btn-success btn-xs" title="Nueva cuenta auxiliar">
                                <i class="fa fa-plus" aria-hidden="true"></i> Nuevo
                            </a>

                            <a href="{{ URL::to('/admin/variasaux') }}" class="btn btn-success btn-xs" title="Registrar Varias Auxiliares">
