            ...
            <div class="col-md-10 col-lg-10 col-xs-10 col-sm-10">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="{{ url('/admin/clase/' . $clase->id . '/edit') }}" title="Editar clase"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> Clase </th><td> {{ $clase->clase }} </td></tr><tr><th> Código </th><td> {{ $clase->codigo }}. </td></tr><tr><th> Detalle </th><td> {{ $clase->detall }} </td></tr><tr><th> Activo </th><td> @if(($clase->activo)=='1')
