                            ...
                            <table class="table table-borderless">
                                ...
                                @foreach($cliente as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->mail_cli }}</td>
                                        <td>
                                            <a href="{{ url('/admin/cliente/' . $item->id) }}" title="Ver Cliente"><button class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> Ver</button></a>
                                            <a href="{{ url('/admin/cliente/' . $item->id . '/edit') }}" title="Editar Cliente"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>
