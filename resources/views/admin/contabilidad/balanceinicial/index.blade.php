                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <label class="control-label">Cuadre : </label>
                                    @if(($asiento->saldo_debe)==($asiento->saldo_haber))
                                <label class="control-label label-success">
                                    Asiento Cuadrado 
                                </label>                
                                    @else
                                <label class="control-label label-danger">
                                    Asiento Descuadrado
                                </label>
                                    @endif
                            </div>
                            <div class="col-md-6">
                                ...
                                <label class="control-label ">
                                    ...
                                    (Debe : {{ number_format($asiento->saldo_debe,2) }} )
                                    (Haber : {{ number_format($asiento->saldo_haber,2) }})
                                </label>                
