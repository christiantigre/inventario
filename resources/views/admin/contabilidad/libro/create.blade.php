  ...
  <section class="content">
    ...
    <div class="col-md-10 col-lg-10 col-xs-12 col-sm-8">
      <div class="panel panel-default">
        <div class="panel-heading">Crear Asiento Contable</div>
        <div class="panel-body">
          ...
          <form method="POST" action="{{ url('/admin/libro') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
            {{ csrf_field() }}
            @include ('admin.contabilidad.libro.form')
            ...
            <div class="row">
              <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12"> 
                ...
                <fieldset>
                  ...
                  <button class="btn btn-default btn-sm" title="Vaciar Previo Asiento" id="trashitems" type="button" onClick="trashBalanceInicial(this.id);"><i class="fa fa-trash" aria-hidden="true"></i> Vaciar</button>
                  ...
                  <div class="box-body no-padding">
                    ...
                    <div class="row">
                      <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12"> 
                        ...
                        <button class="btn btn-success btn-md" title="Guardar asiento registrado" id="guardarBalanceInicial" type="button" onClick="guardaAsiento();"><i class="fa fa-save" aria-hidden="true"></i> GUARDAR ASIENTO CONTABLE</button>  
