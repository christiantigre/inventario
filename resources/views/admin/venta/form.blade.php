...
<div class="col-md-12">
    ...
    <div class="form-group {{ $errors->has('num_venta') ? 'has-error' : ''}}">
        ...
        <div class="col-md-3">            
            <!--<input class="form-control input-sm" name="num_venta" type="text" id="num_venta" value="{{ $ventum->num_venta or ''}}" autofocus="autofocus">-->
    ...
    <div class="form-group {{ $errors->has('fecha') ? 'has-error' : ''}}">
        ...
        <div class="col-md-3">
            ...
            <!--<input class="form-control input-sm" name="fecha" type="text" id="fecha" value="{{ $ventum->fecha or ''}}" >-->
