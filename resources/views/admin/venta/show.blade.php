...
<div class="row no-print">
    <div class="col-xs-12">
      ...
      <a href="{{ url('admin/viewfactura',$ventum->id) }}" target="_blanck" class="btn btn-success pull-right" style="margin-right: 5px;">
        <i class="fa fa-eye"></i> VER FACTURA
    </a>
      <a href="{{ url('admin/print',$ventum->id) }}" class="btn btn-primary pull-right" style="margin-right: 5px;">
