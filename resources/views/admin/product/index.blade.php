    ...
    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <a href="{{ URL::to('/admin/product/downloadExcel/xls') }}">
                    <button class="btn btn-success btn-sm">Descargar Excel xls</button>
                </a>
                <a href="{{ URL::to('/admin/product/downloadExcel/xlsx') }}">
                    <button class="btn btn-success btn-sm">Descargar Excel xlsx</button>
                </a>
                <a href="{{ URL::to('/admin/product/downloadExcel/csv') }}">
                    <button class="btn btn-success btn-sm">Descargar CSV</button>
                </a>
                <div class="container">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <form action="{{ URL::to('/admin/product/importexcelProducts') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
