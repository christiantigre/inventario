                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> 
                                    ...
                                    <a href="{{ url('/admin/proveedor/' . $product->id_proveedor) }}" title="Ver Proveedor"><button class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> Ver Proveedor</button></a>
                                    @endif
