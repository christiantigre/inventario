                            ...
                            <tr>
                                <th> Localizado </th><td> 
                                    @if(empty($proveedor->id_pais))
                                        ...
                                        <a href="{{ url('/admin/proveedor/' . $proveedor->id . '/edit') }}" title="Editar Proveedor"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>
                                    @else
                                    {{ $proveedor->Pais->pais }} 
                                    @endif
                                     /
