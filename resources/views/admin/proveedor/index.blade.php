    ...
    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">                      
                ...
                <a href="{{ URL::to('/admin/proveedor/downloadExcel/xls') }}">
                    <button class="btn btn-success btn-sm">Descargar Excel xls</button>
                </a>
                <a href="{{ URL::to('/admin/proveedor/downloadExcel/xlsx') }}">
                    <button class="btn btn-success btn-sm">Descargar Excel xlsx</button>
                </a>
                <a href="{{ URL::to('/admin/proveedor/downloadExcel/csv') }}">
                    <button class="btn btn-success btn-sm">Descargar CSV</button>
                </a>
                <div class="container">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <form action="{{ URL::to('/admin/proveedor/importexcelProveedor') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('/admin/proveedor/' . $item->id) }}" title="Ver Proveedor"><button class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> Ver</button></a>
                                    <a href="{{ url('/admin/proveedor/' . $item->id . '/edit') }}" title="Editar Proveedor"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>
