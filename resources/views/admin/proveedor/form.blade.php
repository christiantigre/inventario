<div class="form-group {{ $errors->has('proveedor') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="proveedor" type="text" id="proveedor" value="{{ $proveedor->proveedor or ''}}" >
    ...
    <label for="tlfn" class="col-md-4 control-label">{{ 'Tlfn' }}</label>
    <div class="col-md-6">
...
<div class="form-group {{ $errors->has('id_canton') ? 'has-error' : ''}}">
    <label for="id_canton" class="col-md-4 control-label">{{ 'Canton' }}</label>
    <div class="col-md-6">
