        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="panel panel-default">
                    <div class="panel-heading">Moneda {{ $moneda->moneda }}</div>
                    <div class="panel-body">
                        ...
                        <a href="{{ url('/admin/moneda/' . $moneda->id . '/edit') }}" title="Editar Moneda"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>

                        <form method="POST" action="{{ url('admin/moneda' . '/' . $moneda->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> Moneda </th><td> {{ $moneda->moneda }} </td></tr><tr><th> Estado </th><td> 
                                     @if(($moneda->estado)=='1')
