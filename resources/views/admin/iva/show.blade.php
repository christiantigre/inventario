    ...
    <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <a href="{{ url('/admin/iva/' . $iva->id . '/edit') }}" title="Editar Iva"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>
                <form method="POST" action="{{ url('admin/iva' . '/' . $iva->id) }}" accept-charset="UTF-8" style="display:inline">
                    {{ method_field('DELETE') }}
                    {{ csrf_field() }}
