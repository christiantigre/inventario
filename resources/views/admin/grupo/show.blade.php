            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="{{ url('/admin/grupo/' . $grupo->id . '/edit') }}" title="Edit Grupo"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> Grupo </th><td> {{ $grupo->grupo }} </td></tr><tr><th> Codigo </th><td> {{ $grupo->codigo }} </td></tr><tr><th> Detall </th><td> {{ $grupo->detall }} </td></tr><tr><th> Activo </th><td> {{ $grupo->activo }} </td></tr><tr><th> Clase Id </th><td> {{ $grupo->clase_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
