    ...
    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <a href="{{ url('/person/marca/create') }}" class="btn btn-success btn-sm" title="Nueva Marca">
                    <i class="fa fa-plus" aria-hidden="true"></i> Nuevo
                </a>
                <form method="GET" action="{{ url('/person/marca') }}" accept-charset="UTF-8" class="navbar-form navbar-right" role="search">
                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('/person/marca/' . $item->id) }}" title="Ver Marca"><button class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> Ver</button></a>
                                    <a href="{{ url('/person/marca/' . $item->id . '/edit') }}" title="Editar Marca"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>

                                    <form method="POST" action="{{ url('/person/marca' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                        {{ method_field('DELETE') }}
                                        {{ csrf_field() }}
