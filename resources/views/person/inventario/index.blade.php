            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <form method="GET" action="{{ url('/person/inventario') }}" accept-charset="UTF-8" class="navbar-form navbar-right" role="search">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        <a href="{{ URL::to('/person/inventario/downloadExcel/xls',['year'=>$year,'month'=>$mensaje]) }}">
                            <button class="btn btn-success btn-sm">Descargar Excel xls</button>
                        </a>
                        <a href="{{ URL::to('/person/inventario/downloadExcel/xlsx',['year'=>$year,'month'=>$mensaje]) }}">
                            <button class="btn btn-success btn-sm">Descargar Excel xlsx</button>
                        </a>
                        <a href="{{ URL::to('/person/inventario/downloadExcel/csv',['year'=>$year,'month'=>$mensaje]) }}">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="col-lg-4 col-md-4">
                            <form method="POST" action="{{ URL::to('/person/inventario/bymonthinv') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                                {{ csrf_field() }}
