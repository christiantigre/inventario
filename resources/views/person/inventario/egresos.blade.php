        ...
        <div class="panel panel-default">
            ...
            <br/>
                <!--Sección para botones de exportar y descarga-->
                 <div class="row">
                    <div class="col-lg-12 col-md-12">
                         <a href="{{ URL::to('/person/inventario/downloadExcelEgresos/xls',['year'=>$year,'month'=>$mensaje,'randostart'=>$rangostart,'rangofinish'=>$rangofinish]) }}">
                            <button class="btn btn-success btn-sm">Descargar Excel xls</button>
                        </a>
                        <a href="{{ URL::to('/person/inventario/downloadExcelEgresos/xlsx',['year'=>$year,'month'=>$mensaje,'randostart'=>$rangostart,'rangofinish'=>$rangofinish]) }}">
                            <button class="btn btn-success btn-sm">Descargar Excel xlsx</button>
                        </a>
                        <a href="{{ URL::to('/person/inventario/downloadExcelEgresos/csv',['year'=>$year,'month'=>$mensaje,'randostart'=>$rangostart,'rangofinish'=>$rangofinish]) }}">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <form method="POST" action="{{ URL::to('/person/inventario/bymonthegre') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="col-lg-4 col-md-4">
                    <form method="POST" action="{{ URL::to('/person/inventario/byrangoegre') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                       {{ csrf_field() }}
                                <div class="form-group">
