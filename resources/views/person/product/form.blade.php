  ...
  <div class="form-group {{ $errors->has('promo') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6 col-lg-8">
      ...
      {!! Form::select('id_category', $category, null, ['class' => 'form-control','id'=>'id_category']) !!}
        ...
        {!! Form::select('id_category', $category, null, ['class' => 'form-control id_category','id'=>'id_category']) !!}
      ...
      <div class="col-md-6 col-lg-8">
        {{--
          {!! Form::select('id_subcategory', $subcategory, null, ['class' => 'form-control id_subcategory','id'=>'id_subcategory']) !!}
          --}}
